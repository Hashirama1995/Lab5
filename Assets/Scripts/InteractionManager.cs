...
public class InteractionManager : MonoBehaviour
{
    ...
    [SerializeField] public List<NewEffectOnFace> Faces;
    // Each interaction manager state correlate to UI Screens:
    // Default (0) - _uiScreens[0], SpawnObject(1) - _uiScreens[1] etc.

    private enum InterractionManagerState { Default, SpawnObject, SelectObject, ImageTracker, FaceMask, GetNewFace }
    ...
    private void Awake()
    {
        ...
        //_stateInitializationAction[(int)InterractionManagerState.GetNewFace] = GetNewFace;
    }

    /*
    private void GetNewFace()
    {
